...
from SampleFramework.util.config import SHOP_URL
...
class Products(Util):
    def __init__(self,driver):
        ...
        self.checkout = (By.CSS_SELECTOR, "a[class='nav-link btn btn-primary']")
        self.chkout = (By.CSS_SELECTOR, ".btn.btn-success")
